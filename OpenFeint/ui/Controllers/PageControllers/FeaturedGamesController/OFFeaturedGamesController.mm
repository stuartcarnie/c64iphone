...
@implementation OFFeaturedGamesController
...
- (void)loadWebContent
{
	...
	MPURLRequestParameter* clientAppIdParam = [[[MPURLRequestParameter alloc] initWithName:@"client_application_id" andValue:[OpenFeint clientApplicationId]] autorelease];
	NSMutableArray* params = [NSMutableArray arrayWithObject:landscapeParam];
	[params addObject:orientationParam];
	[params addObject:clientAppIdParam];
	NSString* action = @"featured_apps_by_dev.iphone";
