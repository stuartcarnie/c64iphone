...
const NSString* OpenFeintSettingDashboardOrientation = @"DashboardOrientation";
const NSString* OpenFeintSettingShortDisplayName = @"ShortDisplayName";
const NSString* OpenFeintSettingEnablePushNotifications = @"EnablePushNotifications";
const NSString* OpenFeintSettingDisableUserGeneratedContent = @"OpenFeintSettingDisableUserGeneratedContent";
const NSString* OpenFeintSettingInvertNotifications = @"OpenFeintSettingInvertNotifications";
const NSString* OpenFeintSettingAlwaysAskForApprovalInDebug = @"OpenFeintSettingAlwaysAskForApprovalInDebug";
