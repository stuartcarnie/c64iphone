...
@class NewsletterSignUpViewController;
@class ImageBarControl;

@interface GameShelfController : UIViewController<GameBrowserDetailsViewDelegate> {
	GameBrowserController			*_gameBrowserController;
	NewsletterSignUpViewController	*_newsletterSignUpViewController;
